...
class EnumsTest extends TestCase
{
    ...
    public function testChargingStateValues(): void
    {
        ...
        $this->assertSame(15, ChargingState::NOT_CONNECTED->value);
    }
    ...
    public function testChargingStateTryFrom(): void
    {
        ...
        $this->assertSame(ChargingState::NOT_CONNECTED, ChargingState::tryFrom(15));
    ...
    public function testVehicleStateValues(): void
    {
        ...
        $this->assertSame(0, VehicleState::STARTED->value);
        $this->assertSame(1, VehicleState::DRIVING->value);
        $this->assertSame(2, VehicleState::POWER_OFF->value);
    }

    public function testVehicleStateHelpers(): void
    {
        $this->assertTrue(VehicleState::POWER_OFF->isPowerOff());
        $this->assertFalse(VehicleState::STARTED->isPowerOff());

        $this->assertTrue(VehicleState::STARTED->isPowerOn());
        $this->assertTrue(VehicleState::DRIVING->isPowerOn());
        $this->assertFalse(VehicleState::POWER_OFF->isPowerOn());

        $this->assertTrue(VehicleState::UNKNOWN->isUnknown());
        $this->assertFalse(VehicleState::DRIVING->isUnknown());
    }
