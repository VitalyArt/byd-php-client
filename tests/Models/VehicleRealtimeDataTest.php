...
class VehicleRealtimeDataTest extends TestCase
{
    ...
    public function testVehicleStatePopulation(): void
    {
        ...
        $this->assertSame(VehicleState::ON, $data->getVehicleState());

        $data = new VehicleRealtimeData(['vehicleState' => 0]);
        $this->assertSame(VehicleState::OFF, $data->getVehicleState());
    }
    ...
    public function testChargingStatePopulation(): void
    {
        ...
        $this->assertSame(ChargingState::CONNECTED, $data->getChargingState());
    }
    ...
    public function testOilPercentSentinel(): void
    {
